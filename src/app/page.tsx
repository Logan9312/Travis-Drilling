                ...
                <div className="flex flex-auto flex-col items-center justify-center px-4 py-5">
                  ...
                  <div>
                    ...
                    <p className="mb-4 mt-2 text-gray-600">
                      For any of your agricultural or residential needs, we
                      offer a journeyman service and repair technician with a
            ...
            <div className=" w-full px-4 pt-6 text-center md:w-4/12">
              <div className="relative flex h-full w-full min-w-0 flex-col break-words rounded-xl bg-white shadow-lg">
                <div className="flex-auto px-4 py-5">
                  ...
                  <p className="mb-4 mt-2 text-gray-600">
                    Well abandonment and decomissioning services are available
                    for any unproductive wells.
                  </p>
                  <p className="mb-4 mt-2 text-gray-600">
            ...
            <div className="w-full px-4 pt-6 text-center md:w-4/12 md:pt-12 ">
              <div className="relative flex h-full w-full min-w-0 flex-col break-words rounded-xl bg-white shadow-lg">
                <div className="flex flex-auto flex-col items-center justify-center px-4 py-5">
                  ...
                  <p className="mb-4 mt-2 text-gray-600">
                    Our backhoe service is available for trenching, installation
                    and repair of underground water lines, and more.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="ml-auto mr-auto w-full px-4 md:w-5/12">
              ...
              <p className="flex items-center text-gray-800">
                ...
                <Link href="tel:780-974-3184">
                  <span className="mr-1 font-bold">Phone: </span> (780) 974 -
                  3184{" "}
                </Link>
              </p>
            </div>
          ...
          <div className="flex flex-wrap justify-center text-center">
            <div className="w-full px-4 lg:w-7/12">
              ...
              <p className="mb-4 mt-4 text-lg leading-relaxed text-gray-400">
                Travis Drilling is locally owned and operated in the Onoway
                area. We are dedicated to providing a professional water well
                drilling service.
              </p>
            </div>
          </div>
